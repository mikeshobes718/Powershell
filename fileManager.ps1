...
while ($sw.elapsed -lt $timeout){
    if (test-path C:\Users\u584422\Desktop\Script\Powershell\){
        ...
        Get-ChildItem $driven -Recurse -ErrorAction SilentlyContinue | ForEach-Object { Display_File_Details $_.FullName $_.Length $_.Mode $_.LastWriteTime } #****Works without the Get-ACL command****
        #Get-ChildItem $driven -Recurse -ErrorAction SilentlyContinue | ForEach-Object { Display_File_Details $_.FullName $_.Length $_.Mode $_.LastWriteTime ((Get-ACL $_.FullName).Owner) }
        }
